...
<head>
    ...
    <title>Daily Journey | Admin</title>
...
<body>
    ...
    <div class="container">
        <a class="navbar-brand" href="index.php">
            <img src="img/logoWI.png" alt="Logo" width="30"
            height="30" class="d-inline-block align-text-top me-2"> DailyJourney
        </a>
        <button
...
<!-- footer begin -->
<footer class="text-center p-4 bg-danger-subtle footer fixed-bottom">
    <div>
        <a href="https://www.instagram.com/arkn06_"
        ><i class="bi bi-instagram h2 p-2 text-dark"></i
        ></a>
        <a href="https://wa.me/+6281335674815"
        ><i class="bi bi-whatsapp h2 p-2 text-dark"></i
        ></a>
    </div>
    <div>Muhammad Arkan Yumna &copy; 2024</div>
</footer>
<!-- footer end -->
    <script
